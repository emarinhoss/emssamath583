...
program taylor_converge
    ...
    do j = -20,20,4
       ...
       print '(f10.3,3d19.10,i4)', x, exp_true, y, relative_error, nterms
       enddo
...
!====================================
    ...
    ! local variables:
    real (kind=8) :: term, partial_sum, dummy
    integer :: j
    ...
    do j=1,nmax
     ...
     if (x < 0.d0) then
        y = 1./partial_sum  	! this is the value returned for negative values
     else
	y = partial_sum
     end if
